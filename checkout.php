			...
			<div class="row">
				<form method="post">
					<div class="row">
						...
						<div class="input-field col s4">
							<textarea name="pesan" id="pesan" required cols="30" rows="10" class="materialize-textarea"></textarea><label for="pesan">Pesan Customer</label><br><br>
						</div>
						<!--<div class="row">
						...
						<div class="input-field col s4">
							<textarea name="jasa_paket" id="jasa_paket" required cols="30" rows="10" class="materialize-textarea"></textarea><label for="jasa_paket">Jasa paket</label><br><br>
						</div>
						<div class="input-field col s4">
							<textarea name="ongkos_kirim" id="ongko_kirim" required cols="30" rows="10" class="materialize-textarea"></textarea><label for="ongkos_kirim">Ongkir</label><br><br>
						</div>
						</div>
<br> <br> <br>
						<div class="row">
					...
					if (isset($_POST["checkout"])) 
					{
						...
						$total_pembelian = $totalbelanja + $ongkos_kirim; 

				//1. menyimpan data ke tabel pembelian
						$koneksi->query(" INSERT INTO pembelian (
							id_pelanggan,id_toko,tanggal_pembelian,total_pembelian,alamat_pengiriman,pesan,jasa_paket,ongkos_kirim,totalberat,provinsi,distrik,tipe,kodepos,ekspedisi,paket,ongkir,estimasi)
							VALUES ('$id_pelanggan','$id_toko','$tanggal_pembelian','$total_pembelian','$alamat_pengiriman','$pesan','$jasa_paket','$ongkos_kirim','$totalberat','$provinsi','$distrik','$tipe','$kodepos','$ekspedisi','$paket','$ongkir','$estimasi') ");
